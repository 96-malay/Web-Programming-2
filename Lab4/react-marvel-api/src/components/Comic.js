                ...
                <Card className={classes.card}>
                    ...
                    <CardContent>
                                ...
                                <dl>
                                    ...
                                    {comicData && comicData.data.results[0].characters.available !== 0 ? <dd>{comicData.data.results[0].characters.available}</dd> : <dd>N/A</dd> }
                                        
                                </dl>
                                <dl>
                                    <dt className="title"> Characters:</dt>
                                    {comicData && (comicData.data.results[0].characters.available !== 0) ?
                                        (<dd><ul>{comicData.data.results[0].characters.items.map((character) =>
                            ...
                            <dl>
                                ...
                                {comicData && comicData.data.results[0].stories.items ?
                                    (<dd><ul>{comicData.data.results[0].stories.items.map((story) => (<li>  { story.name }</li>))}</ul></dd>) : (<dd>N/A</dd>)}

						...
						<Link to={`/characters/${show.id}`}>
							...
							<CardContent>
								...
								<Typography variant='body2' color='textSecondary' component='p'>
									{show.description ? show.description.replace(regex, '').substring(0, 63) + '...' : 'No description'}
        ...
        if (error){
            ...
            return (
                <div>
                    ...
                    <br />
                    {(currentPage === 0) ? "": 
                <Link className="showlink" to={`/characters/page/${Number(currentPage )- 1}`} onClick={onClickPrev}>
                  Previous
                </Link>}
          
            {(nextPage !== true) ? "" : 
                <Link className="showlink" to={`/characters/page/${Number(currentPage) + 1}`} onClick={onClickNext}>
                  Next
                </Link>}
                     <br></br>
     <br></br>
